...
<body>
	...
	<form method="post" action="player">
		<table style="width: 100%" border="1">
			...
			<tr>
				<td></td>
				<td><input type="text" data-type="userinput" name="player_name" disabled/></td>
				<td><select name="player_gender" data-type="userinput" disabled>
						<option value="Чоловіча">Чоловіча</option>
						<option value="Жіноча">Жіноча</option>
				</select></td>
				<td><input type="text" data-type="userinput" name="player_birthday" disabled/></td>
				<td><input type="text" data-type="userinput" name="player_country" disabled/></td>
				<td><input type="text" data-type="userinput" name="player_nationality" disabled/></td>
				<td><input type="text" data-type="userinput" name="player_rate" disabled/></td>
				<td><input type="text" data-type="userinput" name="player_matches" disabled/></td>
				<td><input type="text" data-type="userinput" name="player_wins" disabled/></td>
				<td></td>
				<td></td>
				<td></td>
				<td><input type="hidden" name="actiontype" value="addplayer" />
					<input type="submit" name="addplayer" value="Add player" data-type="userinput" disabled/></td>
			</tr>
		</table>
	</form>
	</main>
