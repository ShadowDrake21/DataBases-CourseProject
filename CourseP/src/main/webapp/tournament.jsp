	...
	<form method="post" action="tournament">
		<table style="width: 100%" border="1">
			...
			<c:forEach var="tournament" items="${TournamentListBean.tournamentList}">
				<tr>
					...
					<td><c:url var="deleteUrl" value="/deletetournament.jsp">
						...
						<p>
							<a href="${deleteUrl }" data-type="userlink">Delete tournament</a>
						</p>
						<p>
							<a href="${updateUrl }" data-type="userlink">Update tournament</a>
						</p>
						<p>
			...
			<tr>
				...
				<td><input type="text" data-type="userinput" name="tournament_name" /></td>
				<td><input type="text" data-type="userinput" name="tournament_start" /></td>
				<td><input type="text" data-type="userinput" name="tournament_end" /></td>
				<td><input type="text" data-type="userinput" name="tournament_country" /></td>
				<td><input type="text" data-type="userinput" name="tournament_prize" /></td>
				<td><input type="text" data-type="userinput" name="tournament_matches" /></td>
				<td><input type="text" data-type="userinput" name="tournament_players" /></td>
				<td><input type="text" data-type="userinput" name="tournament_current_champ" /></td>
				<td></td>
				<td><input type="hidden" name="actiontype" value="addtournament" />
					<input type="submit" data-type="userinput" name="addtournament" value="Add tournament" /></td>
			</tr>
		</table>
	</form>
	</main>
