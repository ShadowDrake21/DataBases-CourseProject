...
<body class="body">
	...
	<main class="main">
		<section class="delete">
			<p style="font-weight: 700;">Below match will be deleted:</p>
			...
			<form method="post" action="match">
				<input type="hidden" name="actiontype" value="deletematch" /> <input
					...
					type="submit" name="deletematch" value="Delete match"
					class="btn-custom" /> <input type="button"
					onclick="window.location.href='${matchUrl}'" value="Cancel"
					class="btn-custom" />
			</form>
		</section>
	</main>
