...
<body>
	<p>Please update tournament fields and press Update tournament button or
	...
	<form method="post" action="tournament">
		...
		<p>
			Tournament type: <input type="text" name="tournament_type"
				value="${param.tournament_type }" />
		</p>
		<p>
		...
		<p>
			Tournament number of matches: <input type="text" name="tournament_matches"
				value="${param.tournament_matches }" />
		</p>
		<p>
			Tournament number of players: <input type="text" name="tournament_players"
				value="${param.tournament_players }" />
		</p>
		<p>
			Tournament winner: <input type="text" name="tournament_current_champ"
				value="${param.tournament_current_champ }" />
		</p>
		<input type="submit" name="updatetournament" value="Update tournament" /> <input
