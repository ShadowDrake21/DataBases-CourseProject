			...
			<c:forEach var="openingUsage" items="${OpeningUsageListBean.openingUsageList}">
				<tr>
					...
					<td><c:url var="deleteUrl" value="/deleteopenusage.jsp">
						...
						<p>
							<a href="${deleteUrl }" data-type="userlink">Delete Opening Usage</a>
						</p>
						<p>
							<a href="${updateUrl }" data-type="userlink">Update Opening Usage</a>
						</p></td>
				</tr>
			</c:forEach>
			<tr>
				...
				<td></td>
				<td><input type="text" data-type="userinput" name="usage_points" /></td>
				<td><input type="hidden" name="actiontype" value="addopeningusage" />
					<input type="submit" data-type="userinput" name="addopeningusage" value="Add Opening Usage" /></td>
			</tr>
		</table>
	</form>
	</main>
