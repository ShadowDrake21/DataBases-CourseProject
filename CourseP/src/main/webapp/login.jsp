	...
	<main class="main"">
		<div class="login">
			...
			<form method="post" action="login"
				...
				<label class="login__label"><span>User:</span><input
					type="text" name="username" /></label> <label class="login__label"><span>Password:
				</span><input type="password" name="password" /> </label>
